...
export const Projects = () => {
  ...
  const projects = [
    {
      ...
      imgUrl: projImg1,
      link: "https://customizableportfolio.vercel.app/",
    },
    {
      title: "Gemini Clone",
  ...
  return (
    <section className="project" id="projects">
                ...
                <Tab.Container id="projects-tabs" defaultActiveKey="first">
                  ...
                  <Tab.Content id="slideInUp" className={isVisible ? "animate__animated animate__slideInUp" : ""}>
                    ...
                    <Tab.Pane eventKey="third">
                      <p>Every step forward, no matter how small, is closer to the finish line.</p>
                    </Tab.Pane>
                  </Tab.Content>
                </Tab.Container>
              </div>}
      ...
      <img className="background-image-right" src={colorSharp2} alt="Project Screenshot"/>
    </section>
  )
}
